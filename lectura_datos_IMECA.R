# LECTURA Y LIMPIEZA ARCHIVOS IMECA #

library(dplyr)

getwd()
#Aqui va la ruta donde están alojados archivos
#setwd("datos_IMECA/csv")

#LECTURA DE DATOS
DF.2005<-read.csv("datos_IMECA/csv/imeca2005.csv")
DF.2006<-read.csv("datos_IMECA/csv/imeca2006.csv")
DF.2007<-read.csv("datos_IMECA/csv/imeca2007.csv")
DF.2008<-read.csv("datos_IMECA/csv/imeca2008.csv")
DF.2009<-read.csv("datos_IMECA/csv/imeca2009.csv")
DF.2010<-read.csv("datos_IMECA/csv/imeca2010.csv")
DF.2011<-read.csv("datos_IMECA/csv/imeca2011.csv")
DF.2012<-read.csv("datos_IMECA/csv/imeca2012.csv")
DF.2013<-read.csv("datos_IMECA/csv/imeca2013.csv")
DF.2014<-read.csv("datos_IMECA/csv/imeca2014.csv")
DF.2015<-read.csv("datos_IMECA/csv/imeca2015.csv")
DF.2016<-read.csv("datos_IMECA/csv/imeca2016.csv")
DF.2017<-read.csv("datos_IMECA/csv/imeca2017.csv")
DF.2018<-read.csv("datos_IMECA/csv/imeca2018.csv")
DF.2019<-read.csv("datos_IMECA/csv/imeca2019.csv")
DF.2020<-read.csv("datos_IMECA/csv/imeca2020.csv")
...
write.csv(SO2,"datos_IMECA/datos_limpios/SO2.csv",row.names = FALSE)
write.csv(NO2,"datos_IMECA/datos_limpios/NO2.csv",row.names = FALSE)
write.csv(CO,"datos_IMECA/datos_limpios/CO.csv",row.names = FALSE)
write.csv(PM10,"datos_IMECA/datos_limpios/PM10.csv",row.names = FALSE)
